...
insert into Patients(id,evidential_Number,patient_Age,registered_Date,asa_Factor,treatment_Type,anesthesia_Technique,supervision_Type) values (null,1,52,CURRENT_TIMESTAMP,'3',@TEASER,'zop','ok');
