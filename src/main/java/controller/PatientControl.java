...
public class PatientControl extends MainControl{
	...
	System.out.println("Usuniêto pacjenta");
    }

    public void insertPatient(DateTime currentDate, int i, String string, String string2,
	    AnesthesiaTechnique blokadyNerwow) {
